...
const IRCC = {
  ...
  access: `Administer GCMS access and provide biometric operations support for staff at 60+ Visa Application Centres and Missions abroad, handling account provisioning, permission changes, and urgent technical issues across time zones, with each action logged.`,
...
export const roles = [
  ...
  // 2 ─ FINTRAC Officer, Supervision
  {
    ...
    jobs: [
      irccJob([IRCC.irpa, IRCC.triage, IRCC.pivot, IRCC.identity, IRCC.access]),
    ...
    letter: [
      ...
      `The examination craft itself maps to work I already do. Assessing how an entity documents its obligations: I author and maintain a consolidated SOP and compliance checklist as the primary reference in my concurrent research role, and I keep a regulatory change log that flags risks as rules evolve, so I know what good compliance documentation costs to build and maintain. Analyzing data and writing findings: I run Excel pivot analyses across large federal datasets to surface anomalies, build Power BI dashboards, and write briefing notes for senior management. I am also completing the Google Data Analytics Professional Certificate.`,
  ...
  // 4 ─ CMHC Analyst, Data Quality
  {
    ...
    summary: `Data-quality analyst in practice: I maintain master-record integrity on one of the federal government's largest case-management systems (GCMS at IRCC), investigating probabilistic matches, correcting records, and surfacing anomalies across national datasets. Concurrently, I combine and standardize multi-source public data and build the Power BI dashboards a research team prioritizes by. Excel pivot analysis daily. Active Reliability Status. ${GOOGLE_CERT}`,
    ...
    letter: [
      ...
      `The toolset matches too. I run pivot analyses in Excel across large case datasets to confirm statuses and surface anomalies. In a concurrent research role I take inconsistently formatted public data from Health Canada, the US EPA, and provincial reports, standardize it so it can be compared, and build the cross-jurisdictional Power BI dashboards my team prioritizes markets by. I also quantify data reliability directly, calculating percent agreement and false-positive rates between a real-time method and its lab benchmark, which is the same discipline as measuring a dataset against a quality standard rather than assuming it passes.`,
      `Where I see myself helping CMHC's team: running the recurring quality checks and reconciliations that keep datasets release-ready, chasing root causes of recurring errors rather than re-fixing symptoms, and documenting quality procedures so they survive staff turnover. I write SOPs and briefing notes in my current roles, so turning findings into something a manager or a data steward can act on is familiar ground.`,
  ...
  // 5 ─ Bank of Canada Business Analyst, HR Systems Support
  {
    ...
    letter: [
      ...
      `At IRCC's Operations Support Centre I administer GCMS access for staff at over 60 Visa Application Centres and Missions worldwide: account provisioning, permission changes, and urgent system issues, triaged from a national intake against urgency and capacity, with every action logged. It is service delivery with an audit trail, across time zones, for users who cannot do their jobs until I have done mine. That is, in different clothes, the HR systems support function your posting describes.`,
      `On the analysis side of business analysis: in my concurrent research role I map an end-to-end monitoring workflow to find where handoffs slow things down, author the consolidated SOP the team actually runs on, and keep it current as requirements change. I build Power BI dashboards from multi-source data, run Excel pivot analyses on large operational datasets, and write briefing notes that put tradeoffs in front of senior management in plain language. I am also completing the Google Data Analytics Professional Certificate to formalize and extend that toolkit.`,
  ...
  // 6 ─ Interac Fraud Operations, Countermeasures Specialist
  {
    ...
    jobs: [
      irccJob([IRCC.identity, IRCC.triage, IRCC.pivot, IRCC.access, IRCC.irpa]),
    ...
    letter: [
      ...
      `I should be candid: my title does not say fraud. The day-to-day does. Identity conflicts, duplicate records, document evidence that does not line up, and the judgment call between a false positive and a real problem are my caseload. Before IRCC, I spent three years as the on-floor KYC and credit decision authority at Rogers, the retail front line against subscription and identity fraud, where I also trained every new hire on verification procedure. Coaching a team to hold a compliance line under volume is something I have done for years, not something I would be trying for the first time.`,
      `Where I see myself helping a countermeasures team: working the escalation queue accurately from early on, and then helping measure what the team often has no time to measure. In my concurrent research role I calculate percent agreement and false-positive rates between a real-time detection method and its benchmark, which is the same analytical shape as evaluating whether a countermeasure is catching fraud or just creating friction. I build that kind of reporting in Excel and Power BI, and I am completing the Google Data Analytics Professional Certificate to push it further.`,
  ...
  // 7 ─ Equifax Fraud Investigator, Managed Services
  {
    ...
    jobs: [
      irccJob([IRCC.identity, IRCC.triage, IRCC.pivot, IRCC.citizen, IRCC.access]),
      stelisJob([STELIS.validation, STELIS.brief, STELIS.data, STELIS.changelog]),
      rogersJob([ROGERS.kyc_fraud, ROGERS.train, ROGERS.ops, ROGERS.retention]),
      elementalJob([ELEMENTAL.protocol, ELEMENTAL.refusals, ELEMENTAL.records]),
    ],
    ...
    letter: [
      ...
      `Where I see myself helping the Managed Services team: clearing cases at the productivity-and-quality balance the service is sold on, writing the documented rationale that lets a client audit any decision, and contributing to the quality side of the operation. In my concurrent research role I quantify detection quality directly, calculating percent agreement and false-positive rates between a real-time method and its benchmark in Excel pivot tables, and I build Power BI reporting on operational data. I am completing the Google Data Analytics Professional Certificate to extend exactly that skill set.`,
