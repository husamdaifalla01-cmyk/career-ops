...
export const terms: Term[] = [
  ...
  },
  {
    ...
    classes: [
      ...
      c("CHM 2123", "LAB.OF ORGANIC CHEMISTRY II", "A-", 24.0),
      c("POL 2101", "INTRO TO CANADIAN POLITICS", "A", 27.0),
    ],
    stats: {
      unitsTowardGPATaken: p(12.0, 156.0),
      unitsTowardGPAPassed: p(12.0, 156.0),
      unitsNotForGPATaken: p(null, 0.0),
      unitsTransfer: p(null, 6.0),
      totalGradePoints: p(96.0, 1236.0),
      unitsTakenTowardGPA: p(12.0, 156.0),
